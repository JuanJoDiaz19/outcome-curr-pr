...
//    @Bean
//    @Transactional
//    CommandLineRunner commandLineRunner(PiLvlCategRepository piLvlCategRepository,
...
//    ) {
//        User testUser = User.builder().usrName("OutCurrTestUser").build();
//        Faculty testFaculty = Faculty.builder().facNameEng("Engineering").facNameSpa("Ingeniería").users(List.of(testUser))
//                .build();
//
...
//
//        return args -> {
//            Faculty facultySaved = facultyRepository.save(testFaculty);
//            acadProgram.setFaculty(facultySaved);
